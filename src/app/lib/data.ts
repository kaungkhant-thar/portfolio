export const projectsData = [
  ...
  {
    id: "2",
    title: "Chat-PDF AI Assistant",
    description:
      "A ChatGPT-powered application where users can upload PDFs and interact with them through natural language. Features include PDF parsing, chunking, embedding, and conversational memory, all powered by OpenAI and vector databases.",
    tags: [
      "Next.js",
      "OpenAI",
      "LangChain",
  ...
  {
    id: "3",
    title: "Power Barre Yoga Booking Site",
    description:
      "A professionally designed scheduling and booking platform for Power Barre Yoga, built on top of the Rezerv SaaS system. Features include responsive UI, studio branding, optimized mobile experience, and seamless class registration for clients.",
    tags: [
      "React",
      "Next.js",
      "TailwindCSS",
